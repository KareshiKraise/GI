...
//layout(std430, binding = 3) buffer pass_vpl_count {
//	unsigned int pass_count;
//};

//#define NUM_CLUSTER_VAL 4
//layout(std140, binding = 0) uniform val_mats
//{
//	mat4 parabolicView[NUM_CLUSTER_VAL];
//};
...
void main()
{
	...
	vec2 uv = imageLoad(samples, int(gl_LocalInvocationIndex)).xy;
