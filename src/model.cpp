...
{
	vertexarray.init(&vertices[0], vertices.size()*sizeof(vertex));
	vertexarray.bind();
	vertexarray.set_element_buffer(&indices[0], indices.size() * sizeof(unsigned int));	
	vertexarray.set_vertexarrays(3, sizeof(vertex), 0, GL_FLOAT);
	vertexarray.set_vertexarrays(2, sizeof(vertex), offsetof(vertex, uv), GL_FLOAT);
	vertexarray.set_vertexarrays(3, sizeof(vertex), offsetof(vertex, normal), GL_FLOAT);
	vertexarray.set_vertexarrays(3, sizeof(vertex), offsetof(vertex, tangent), GL_FLOAT);
	vertexarray.set_vertexarrays(3, sizeof(vertex), offsetof(vertex, bitangent), GL_FLOAT);
	vertexarray.unbind();
