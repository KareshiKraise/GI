...
struct program
{
	...
	program(const char* vertexPath, const char* fragmentPath, const char* geometryPath = nullptr, const char* computePath = nullptr)
	{
		init(vertexPath, fragmentPath, geometryPath, computePath);
	}

	void init(const char* vertexPath, const char* fragmentPath, const char* geometryPath = nullptr, const char* computePath = nullptr) {
